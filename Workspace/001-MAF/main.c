...
int main(void)
{
    ...
    for(i=0;i<=45;i++){
        y2[i] = (noisysine[i]+noisysine[i+1]+noisysine[i+2]+noisysine[i+3]+noisysine[i+4])/5;
    }
    y2[46] = (noisysine[45]+noisysine[46]+noisysine[47])/3;
    y2[47] = (noisysine[46]+noisysine[47]+noisysine[48])/3;
    y2[48] = (noisysine[47]+noisysine[48]+noisysine[49])/3;
    y2[49] = noisysine[49];
